...
STUBS = app seccomp_framework/seclib seccomp_framework/sec_client seccomp_framework/sec_tracer seccomp_framework/sec_ptrace_lib seccomp_framework/sec_syscall_emulator seccomp_framework/sec_seccomp_rules seccomp_framework/sec_seccomp_bpf_generator
